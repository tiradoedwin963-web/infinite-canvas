...
摄影检查只读取 ShotPlan 中已经选定的方案：评估景别节奏、主要运镜可执行性、复杂运镜与人物动作的可读性、光源与色彩连续。跳轴、倾斜机位、失衡构图、连续特写/远景或静态画面可产生建议性警告，不回退或拒绝已通过结构校验的镜头；空镜只要场景和实际出镜道具引用正确，不要求人物资产。多镜头视频片段可检查片段内 HARD CUT、匹配切、动作接切、眼神承接、遮挡切和声音撞击；不设计 J-cut、L-cut 或跨片段声音提前/延续。
